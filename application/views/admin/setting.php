      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            <div class="col-sm-4">
              <h3>系統公告設定</h3>
              <form class="form-signin" role="form" action="<?=base_url('admin/setting_do/setannounce');?>" method="POST">
                <input type="text" id="announce" name="announce" class="form-control" value="<?=$announce_text;?>" required>
