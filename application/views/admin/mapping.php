...
<html lang="en">
  <head>
    ...
    <title>票別對應設定 | NTUvoteV2 後台管理</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">票別對應設定</h1>
          <p>此處為關連票別與票種用，為票別建立完整的票種。</p>

          
          <div class="col-sm-4">
            <form class="form-signin" role="form" action="<?=base_url('admin/mapping_do');?>" method="POST">
              <p>票別：<?=$ballot_list_name;?></p>
              <p>票種：</p>
              <?=$mapping_html;?>
              <br />
