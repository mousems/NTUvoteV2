      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="col-sm-4">
            ...
            <form class="form-signin" role="form" action="<?=base_url('admin/ballot_list_new_do');?>" method="POST">
              <input type="text" id="name" name="name" class="form-control" placeholder="票別名稱" required>
              <input type="text" id="prefix" name="prefix" class="form-control" placeholder="授權碼前綴" required autofocus>
